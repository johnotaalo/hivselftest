...
<div class="logo has-logo-light has-logo-dark" style="width:10%;height:80%;margin-top: 5px;">
<a href="<?= @base_url();?>" rel="home">
	<img class="logo-default"  src="<?= @$assets_url; ?>img/banners/besure-logo.png" alt="Besure-Logo">
	<img class="logo-light"  src="<?= @$assets_url; ?>img/banners/besure-logo-grey.png" alt="Besure-Logo">
	<img class="logo-dark"  src="<?= @$assets_url; ?>img/banners/besure-logo-white.png" alt="Besure-Logo">
