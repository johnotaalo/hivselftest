...
<div class="row-wrapper row-no-bottom-margin row-full-height">
	<div class="row-container container row-full-width row-no-padding">
		<div class="row columns-equal-height columns-content-middle columns-no-margins">
			<div class="column col-sm-3 col-md-6">
				<div class="column-inner custom-css-1488423852758">
					<div class="bg-media">
						<div class="bg-media-container" data-bottom-top="transform: translate3d(0,0%,0)" data-top-bottom="transform: translate3d(0,55%,0)">
							...
							<div style="background-image:url(data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=);background-repeat:no-repeat;background-position:center center;" class="preload-bg-image bg-image bg-gallery-item lazy-load-bg-img" data-src="<?= @$assets_url; ?>img/picktwo.png"></div>
							<div style="background-image:url(data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=);background-repeat:no-repeat;background-position:center center;" class="preload-bg-image bg-image bg-gallery-item lazy-load-bg-img" data-src="<?= @$assets_url; ?>img/pickthree.png"></div>
							<div style="background-image:url(data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=);background-repeat:no-repeat;background-position:center center;" class="preload-bg-image bg-image bg-gallery-item lazy-load-bg-img" data-src="<?= @$assets_url; ?>img/pickfour.png"></div>
							<div style="background-image:url(data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=);background-repeat:no-repeat;background-position:center center;" class="preload-bg-image bg-image bg-gallery-item lazy-load-bg-img" data-src="<?= @$assets_url; ?>img/pickfive.png"></div>
							<div style="background-image:url(data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=);background-repeat:no-repeat;background-position:center center;" class="preload-bg-image bg-image bg-gallery-item lazy-load-bg-img" data-src="<?= @$assets_url; ?>img/picksix.png"></div>
							<div style="background-image:url(data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=);background-repeat:no-repeat;background-position:center center;" class="preload-bg-image bg-image bg-gallery-item lazy-load-bg-img" data-src="<?= @$assets_url; ?>img/pickseven.png"></div>
							<div style="background-image:url(data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=);background-repeat:no-repeat;background-position:center center;" class="preload-bg-image bg-image bg-gallery-item lazy-load-bg-img" data-src="<?= @$assets_url; ?>img/pickeight.png"></div>
							</div>
						</div>
					</div>
			...
			<div class="column col-sm-9 col-md-6">
